...
SW_VERSION=4.94
curl --output /tmp/ids-software-suite-linux-${SW_VERSION}-64.tgz https://de.ids-imaging.com/files/downloads/ids-software-suite/software/linux-desktop/ids-software-suite-linux-${SW_VERSION}-64.tgz
